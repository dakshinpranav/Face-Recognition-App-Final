      ...
      <View style={styles.container}>
        ...
        <View style={styles.framesContainer}>
          <View style={styles.catagoryContainer}>
            <TouchableOpacity
              style={
                this.state.selectedFrame === 'Round'
                  ? styles.selectedFrameBox
                  : styles.frameBox
              }
              onPress={() => this.setState({ selectedFrame: 'Round' })}>
              <Text>Round</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={
                this.state.selectedFrame === 'Rimless'
                  ? styles.selectedFrameBox
                  : styles.frameBox
              }
              onPress={() => this.setState({ selectedFrame: 'Rimless' })}>
              <Text>Rimless</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={
                this.state.selectedFrame === 'Regular'
                  ? styles.selectedFrameBox
                  : styles.frameBox
              }
              onPress={() => this.setState({ selectedFrame: 'Regular' })}>
              <Text>Regular</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={
                this.state.selectedFrame === 'Aviators'
                  ? styles.selectedFrameBox
                  : styles.frameBox
              }
              onPress={() => this.setState({ selectedFrame: 'Aviators' })}>
              <Text>Aviators</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={
                this.state.selectedFrame === 'Wayfers'
                  ? styles.selectedFrameBox
                  : styles.frameBox
              }
              onPress={() => this.setState({ selectedFrame: 'Wayfers' })}>
              <Text>Wayfers</Text>
            </TouchableOpacity>
          </View>
          <ScrollView
            ...
            {data[this.state.selectedFrame].map((filter_data) => {
              return (
                <TouchableOpacity
